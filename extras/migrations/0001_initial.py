    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latitude', models.FloatField(help_text='Geographic latitude coordinate', verbose_name='Latitude')),
                ('longitude', models.FloatField(help_text='Geographic longitude coordinate', verbose_name='Longitude')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['user', 'is_default'], name='extras_addr_user_id_4e787b_idx'), models.Index(fields=['address_type'], name='extras_addr_address_f03c53_idx')],
