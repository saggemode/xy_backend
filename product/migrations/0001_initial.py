    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('variant_type', models.CharField(choices=[('color', 'Color'), ('size', 'Size'), ('style', 'Style'), ('material', 'Material'), ('other', 'Other')], default='other', help_text='Type of variant (color, size, style, etc.)', max_length=20)),
                ('sku', models.CharField(blank=True, max_length=50, unique=True)),
                ('pricing_mode', models.CharField(choices=[('adjustment', 'Price Adjustment'), ('individual', 'Individual Price')], default='adjustment', help_text='Price adjustment: adds to product base price. Individual price: sets specific price for this variant.', max_length=20)),
                ('price_adjustment', models.DecimalField(decimal_places=2, default=0, help_text="Amount to add/subtract from product base price (used when pricing_mode is 'adjustment')", max_digits=10)),
                ('individual_price', models.DecimalField(blank=True, decimal_places=2, help_text="Specific price for this variant (used when pricing_mode is 'individual')", max_digits=10, null=True)),
